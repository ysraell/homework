...
function [R_MDA,MC_MDA,num_max] = PCA_actions(trajectories,test_samples,training_samples,dist_method_type,Dim,r,Func,Algorithm)
    ...
    switch Func
        ...
        case 'm'
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % PCA subspace optimal use MATLAB's function
             [V,~,L] = pca(Y,'Economy',true,'Algorithm',Algorithm);
        case 'u'
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % PCA subspace optimal use our own function
             [V,L] = subspace_proj_PCA(training_samples,trajectories);
    end
