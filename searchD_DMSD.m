...
num_max = -ones(3,2,T_d,T_rounds,T_bal);
...
%             end
                ...
                disp(texto)
                tic
                [R(d,r,b),MC(:,:,d,r,b),num_max(:,:,d,r,b)] = DMSD_actions(trajectories,test_samples,training_samples,dist_method_type,dim_opt_proj,Dim(d),r,zeta);
                time(d,r,b) = toc;
        end
    end
end
