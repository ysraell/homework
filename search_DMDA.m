...
% adjust=1;
% % Dim = [0.9 0.99 1-4.50359962738.*eps*10.^[12 11 10 9 8 7 6 5 4 3]]';
% Dim = [0.9:0.01:0.99 0.999 0.9999];
% T_d = max(size(Dim));
% 
% rr = 1;
% dist_method_type = 'mgo';
% dim_opt_proj = 2;
% tolerancia = 0;
% zeta = -3.*ones(3,1);
% 
...
%                 disp(texto)
%                 tic
%                 [R(d,r,b),MC(:,:,d,r,b),num_max(1:dim_opt_proj,:,d,r,b)] = DMDA_actions(trajectories,test_samples,training_samples,dist_method_type,dim_opt_proj,Dim(d),r,adjust);
%                 time(d,r,b) = toc;
%         end
%     end
% end
