...
function [R_,MC_] = TB_actions(trajectories,test_samples,training_samples,NTrees,Method)
    ...
    Model = TreeBagger(NTrees,Y,C,'Method',Method);
...
%             index_img = predict(Model,A);
            index_img = str2num(cell2mat(predict(Model,A)));
